...
public partial class AirConditionerShop2023DbHackerLoContext : DbContext
{
    public AirConditionerShop2023DbHackerLoContext()
    {
    }

    public AirConditionerShop2023DbHackerLoContext(DbContextOptions<AirConditionerShop2023DbHackerLoContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AirConditionerId).HasName("PK__AirCondi__EE2EB7395D7E1180");
        ...
        {
            entity.HasKey(e => e.MemberId).HasName("PK__StaffMem__0CF04B383749AB98");

            entity.ToTable("StaffMember");

            entity.HasIndex(e => e.EmailAddress, "UQ__StaffMem__49A14740A07146D5").IsUnique();
        ...
        {
            entity.HasKey(e => e.SupplierId).HasName("PK__Supplier__4BE666B4AD9187D9");
